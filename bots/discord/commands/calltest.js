module.exports = function(m) {
    ...
    /**
     * Si la commande n'est pas calltest, alors finir la fonction
     */
    if (m.command !== "calltest") return false;

    /**
     * Si la commande ne contient pas 2 arguments, finir la fonction et renvoyer une erreur
     */
    if(m.args.length != 2) return embed(m.message, 'Need more arguments', 15158332, 'You need to give 2 arguments, example : **!calltest 33612345678 paypal**', m.user);
